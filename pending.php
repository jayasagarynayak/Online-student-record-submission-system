...
{
	echo "<center><b><h3 style='color:red;'>Pending Status</h3></b><center>";
$usn=$_POST["usns"];
$name=$_POST["names"];
...
while($row1=mysqli_fetch_assoc($result2))
{
	//echo $row1["SUBJECT"];
	$sub=$row1["SUBJECT"];
	$query3="select * from submission where SUBJECT='$sub' and USN='$usn' and STATUS='PENDING'";
	...
	echo "<tr><th style='width:5%;'>Sl. No.</th><th style='width:9%;'>Program No.</th><th style='width:75%;'>Statement</th><th style='width:10%;'>Status</th></tr>";
	if($count==0)
	{
		echo "<tr><td colspan='5' style='text-align:center;'>No Pending Status Found...!</td></tr>";
